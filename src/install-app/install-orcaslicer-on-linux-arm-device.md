---
title: Install OrcaSlicer on Linux ARM Device | Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/OrcaSlicer/icon-64.png" height=24> OrcaSlicer on Linux ARM Device
...
Fortunately, OrcaSlicer is very easy to install on your Linux ARM Device in just two steps.
...
OrcaSlicer will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install OrcaSlicer on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
