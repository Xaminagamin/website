---
title: Install iDescriptor on Linux ARM Device | Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/iDescriptor/icon-64.png" height=24> iDescriptor on Linux ARM Device
...
Fortunately, iDescriptor is very easy to install on your Linux ARM Device in just two steps.
...
iDescriptor will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install iDescriptor on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
