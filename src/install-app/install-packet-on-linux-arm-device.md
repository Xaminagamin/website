---
title: Install Packet on Linux ARM Device | Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Packet/icon-64.png" height=24> Packet on Linux ARM Device
...
Fortunately, Packet is very easy to install on your Linux ARM Device in just two steps.
...
Packet will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install Packet on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
